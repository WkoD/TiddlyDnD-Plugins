...
if (!yearonly) {
   ...
   if (dateStart.length > 1) {
      ...
      resultStart = require("$:/plugins/dndwiki-core/macros/library").getMonatTag(dateStart[1], dateStart[2]);
      ...
      if (dates.length > 1) {
         var retEnd = "";
         resultEnd = require("$:/plugins/dndwiki-core/macros/library").getMonatTag(dateEnd[1], dateEnd[2]);
